...
export async function getIGDBMetadata(gameId: string): Promise<GameMetadata | null> {
  const query = `
...
export async function getIGDBMetadataByName(gameName: string): Promise<GameMetadata | null> {
