...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        'dark:bg-popover/(--glass-opacity) dark:backdrop-filter dark:backdrop-blur-[32px] bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-lg',
        className
      )}
      {...props}
    />
