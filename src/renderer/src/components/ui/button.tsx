...
const buttonVariants = cva(
  'inline-flex items-center non-draggable justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary/90 text-primary-foreground shadow hover:bg-primary/80 shadow-sm',
        destructive:
          'bg-destructive/90 text-destructive-foreground shadow-sm hover:bg-destructive/80',
        outline:
          'border border-input bg-background/[0.35] shadow-sm hover:bg-accent hover:text-accent-foreground shadow-sm',
