...
function Input({ className, type, ...props }: React.ComponentProps<'input'>): React.JSX.Element {
  return (
    <input
      ...
      spellCheck="false"
      className={cn(
        'non-draggable border-0 shadow-sm file:text-foreground placeholder:text-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/[calc(var(--glass-opacity)/2)] flex h-9 w-full min-w-0 rounded-md bg-transparent px-3 py-1 text-base transition-[color_box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
