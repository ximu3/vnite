...
export function Appearances(): JSX.Element {
  ...
  const [localBackgroundImageCompressionFactor, setLocalBackgroundImageCompressionFactor] =
    useState(compressionBackgroundImageFactor)
  ...
  useEffect(() => {
    window.api.theme
      .getConfigBackground('buffer', true)
      .then((names: string[]) => {
      ...
      <CardContent>
        <div className={cn('flex flex-col gap-8')}>
          ...
          <div className={cn('space-y-4')}>
            <div className={cn('border-b pb-2 select-none')}>
              {t('appearances.background.title')}
            </div>
            ...
            <div className={cn('pl-2')}>
              <div className={cn('grid grid-cols-[1fr_auto] gap-4 items-center')}>
                ...
                <Select value={customBackgroundMode} onValueChange={setCustomBackgroundMode}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectLabel className="select-none">
                        {t('appearances.background.source.library')}
                      </SelectLabel>
                      <SelectItem value="default">
                        {t('appearances.background.type.default')}
                      </SelectItem>
                      <SelectLabel className="select-none">
                        {t('appearances.background.source.custom')}
                      </SelectLabel>
              ...
              <>
                                ...
                                customBackgroundMode === 'slideshow' && (
                                  <div className="flex justify-between w-full mt-2">
                                    <button
                                      type="button"
                                      onClick={() =>
                                        setCurrentBackgroundIndex((i) =>
                                          i === 0 ? backgroundImages.length - 1 : i - 1
                                        )
                                      }
                                    ...
                                    <button
                                      ...
                                      onClick={() =>
                                        setCurrentBackgroundIndex((i) =>
                                          i === backgroundImages.length - 1 ? 0 : i + 1
                                        )
                                      }
                                      className="px-2 py-1 text-sm"
                                    >
                ...
                <div className={cn('pl-2')}>
                  <div className={cn('grid grid-cols-[1fr_auto] gap-4 items-center')}>
                    ...
                    <div
                      className={cn(
                        'flex items-center gap-2 w-[250px]',
                        !compressionBackgroundImageStatus &&
                    ...
                    >
                      ...
                      />
                      <span
                        className={cn('text-sm text-muted-foreground w-12 text-right select-none')}
                      >
          ...
          <div className={cn('space-y-4')}>
            <div className={cn('border-b pb-2 select-none')}>
              {t('appearances.gameDetail.title')}
            </div>
            <div className={cn('pl-2')}>
              <div className={cn('grid grid-cols-[1fr_auto] gap-4 items-center')}>
                <div className={cn('whitespace-nowrap select-none')}>
